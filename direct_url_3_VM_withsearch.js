...
(async () => {
    ...
    for (let i = 0; i < 15; i++) { // Loop to run 15 iterations
        ...
        try {
            ...
            await page.goto('https://lao-sit.1901.carlsberg.com/en');
...
*/	
	await new Promise(resolve => setTimeout(resolve, 5000)); // Delay for 5 seconds
            ...
            fs.writeFileSync(`./Report/SIT/21May_Desktop_place_order/flow_${i + 1}.report.html`, lhFlowReport);
            ...
            fs.writeFileSync(`./Report/SIT/21May_Desktop_place_order/flow_${i + 1}_failure.report.html`, failureReport);
